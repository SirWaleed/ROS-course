...
(cl:defmethod cl:initialize-instance :after ((m <comp_num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'comp_num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_t-msg:<comp_num> is deprecated: use robot_t-msg:comp_num instead.")))

(cl:ensure-generic-function 'real-val :lambda-list '(m))
(cl:defmethod real-val ((m <comp_num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_t-msg:real-val is deprecated.  Use robot_t-msg:real instead.")
  (real m))

(cl:ensure-generic-function 'imaginary-val :lambda-list '(m))
(cl:defmethod imaginary-val ((m <comp_num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_t-msg:imaginary-val is deprecated.  Use robot_t-msg:imaginary instead.")
  (imaginary m))
