...
class num_wordsRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type num_wordsRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type num_wordsRequest
    let len;
    let data = new num_wordsRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new num_wordsRequest(null);
...
class num_wordsResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type num_wordsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type num_wordsResponse
    let len;
    let data = new num_wordsResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new num_wordsResponse(null);
...
module.exports = {
  Request: num_wordsRequest,
  Response: num_wordsResponse,
  md5sum() { return 'b4834320f090e9235da913886638fb4e'; },
  datatype() { return 'robot_t/num_words'; }
};
